...
export const scenes: Scene[] = [
  ...
  },
  {
    ...
    reveals: [],
    newConnections: ['conn-7', 'conn-4', 'conn-11'],
    notebookEntry: '真相全部揭开。王副局长是保护严迪的幕后操盘手，精心布局了这盘大棋。境外操控者以为通过电话遥控了严迪，实际严迪一直在反向输送假情报！白帆只是境外情报机构的一颗棋子。每个人都在不知不觉中成为了这场谍战的一部分。',
  },
];
